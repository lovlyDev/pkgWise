...
executing project code, builds a dependency graph, produces evidence-backed findings and transparent
scores, and provides cached npm Registry and OSV enrichment.
...
console.log(report.scores, report.findings);
```
